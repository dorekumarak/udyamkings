...
// Initialize express
const app = express();
const PORT = process.env.PORT || 3002;  // Default to port 3002
...
app.get('/apply', (req, res) => {
  res.render('apply', { 
    title: 'Apply for Investment | UdyamKings',
    page: 'apply',
    description: 'Apply for funding and mentorship from UdyamKings. Turn your business idea into reality with our support.',
    appUrl: process.env.APP_URL || 'http://localhost:3000'
  });
});
...
const startServer = async () => {
  try {
    ...
    const server = https.createServer(options, app).listen(PORT, '0.0.0.0', () => {
      ...
      console.log(`🌐 Access the site at: https://localhost:${PORT}`);
